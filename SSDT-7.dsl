 ...
 *
 * Disassembly of SSDT-7.aml, Tue Oct  3 13:20:15 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00006028 (24616)
 *     Revision         0x02
 *     Checksum         0xF6
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (OESC, MethodObj)    // 1 Arguments
    External (OSYS, FieldUnitObj)
    External (PNHM, FieldUnitObj)
    External (S0ID, FieldUnitObj)
    External (SCIS, FieldUnitObj)

    OperationRegion (SANV, SystemMemory, 0x9AC41E18, 0x018A)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            While (LLess (\_SB.PCI0.PEG0.LKSS, 0x07))
            {
                ...
                While (Local0)
                {
                    If (LLess (\_SB.PCI0.PEG0.LKSS, 0x07))
                    {
                        Stall (0x64)
                        Decrement (Local0)
                    }
