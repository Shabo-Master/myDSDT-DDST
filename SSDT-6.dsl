 ...
 *
 * Disassembly of SSDT-6.aml, Tue Oct  3 13:20:15 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00006014 (24596)
 *     Revision         0x02
 *     Checksum         0xD5
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.CHGR, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.ECAV, IntObj)
    External (_SB_.PCI0.LPCB.H_EC.ECMD, MethodObj)    // Imported: 1 Arguments
    External (_SB_.PCI0.LPCB.H_EC.ECRD, MethodObj)    // Imported: 1 Arguments
    External (_SB_.PCI0.LPCB.H_EC.ECWT, MethodObj)    // Imported: 2 Arguments
    External (_SB_.PCI0.LPCB.H_EC.HYST, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.PENV, IntObj)
    External (_SB_.PCI0.LPCB.H_EC.PINV, IntObj)
    External (_SB_.PCI0.LPCB.H_EC.PMAX, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.PPSH, IntObj)
    External (_SB_.PCI0.LPCB.H_EC.PPSL, IntObj)
    External (_SB_.PCI0.LPCB.H_EC.PSTP, IntObj)
    ...
    External (_SB_.PCI0.LPCB.H_EC.TSHT, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.TSI_, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.TSLT, UnknownObj)    // Warning: Unknown object
        ...
        Device (TMEM)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                If (\_SB.PCI0.LPCB.H_EC.ECAV)
                {
                    ...
                    ElseIf (LGreater (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7))))
                    {
                        Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), Local1)
                    }
                    Else
                    {
                        Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7)), Local1)
                    }
    ...
    Scope (\_SB.PCI0.LPCB.H_EC)
    {
        Device (CHRG)
        {
            ...
            Method (SPPC, 1, Serialized)
            {
                ...
                {
                    Store (DerefOf (Index (DerefOf (Index (PPSS, Arg0)), 0x04)), Local1)
    ...
    Scope (\_SB.IETM)
    {
        ...
        Method (_TRT, 0, NotSerialized)  // _TRT: Thermal Relationship Table
        {
            If (\_SB.PCI0.LPCB.H_EC.ECAV)
            {
                If (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.CFAN)))
                {
                    If (LLessEqual (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PENV)), 0x23))
                    {
                        Return (TRTD)
                    }

                    If (LLessEqual (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PENV)), 0x41))
                    {
                        Return (TRT7)
                    }

                    If (LLessEqual (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PENV)), 0x64))
                    {
                        Return (TRT0)
                    }
                }
