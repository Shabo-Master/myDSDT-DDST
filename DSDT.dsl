 ...
 *
 * Disassembly of DSDT.aml, Tue Oct  3 13:20:15 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00012DC3 (77251)
 *     Revision         0x02
 *     Checksum         0x29
 *     OEM ID           "DELL  "
 *     OEM Table ID     "QA09   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "QA09   ", 0x01072009)
{
     ...
     * disassembly, but only 15 were resolved (8 unresolved). Additional
    ...
    External (_SB_.IAOE.OAOS, UnknownObj)    // Warning: Unknown object
    ...
    //External (PQE*, UnknownObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x9AC44000, 0x035A)
    ...
    OperationRegion (DGNA, SystemMemory, 0x9AC42018, 0x103D)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Method (SPTS, 1, NotSerialized)
                {
                    ...
                    If (LEqual (NEXP, Zero))
                    {
                        If (LAnd (LEqual (RP3D, Zero), LEqual (^^RP03.RPAV, One)))
                        {
                            ^^RP03.HPME ()
                        }
                    }
                ...
                OperationRegion (CPSB, SystemMemory, 0x9A23EF18, 0x10)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (SIRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y1C._BAS, BR01)  // _BAS: Base Address
                CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y1D._BAS, BR03)  // _BAS: Base Address
                Store (SB10, BR01)
                Store (SB12, BR03)
        ...
        Device (GPI0)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y1E._MIN, BMIN)  // _MIN: Minimum Base Address
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y1E._MAX, BMAX)  // _MAX: Maximum Base Address
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                Store (GPMN, BMIN)
                Store (GPMX, BMAX)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL0._CRS._Y1F._INT, VAL4)  // _INT: Interrupts
                    Store (0x1F, VAL4)
                }
        ...
        Device (TPL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL1._CRS._Y20._INT, VAL4)  // _INT: Interrupts
        ...
        Device (TPL2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (IRBU, \_SB.PCI0.I2C1.TPL2._CRS._Y21._INT, VAL4)  // _INT: Interrupts
                    Store (0x1F, VAL4)
                }

                CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPL2._CRS._Y22._SPE, I2CG)  // _SPE: Speed
                Store (TL2F, I2CG)
                If (LEqual (BID, 0x31))
                {
        ...
        Device (TPL3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL3._CRS._Y23._INT, VAL4)  // _INT: Interrupts
                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    Store (0x1F, VAL4)
                }
        ...
        Device (TPD0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y24._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                }

                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y24._INT, VAL4)  // _INT: Interrupts
                    Store (0x1A, VAL4)
                }
        ...
        Device (TPD1)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y25._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                }

                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y25._INT, VAL4)  // _INT: Interrupts
                    Store (0x1A, VAL4)
                }
        ...
        Device (TPD2)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y26._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                }

                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y26._INT, VAL4)  // _INT: Interrupts
                    Store (0x1A, VAL4)
                }
        ...
        Device (TPD3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y27._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                }

                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y27._INT, VAL4)  // _INT: Interrupts
                    Store (0x1A, VAL4)
                }
        ...
        Device (TPD7)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y28._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                    If (LEqual (S0ID, Zero))
                    {
                ...
                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y28._INT, VAL7)  // _INT: Interrupts
                    Store (0x1A, VAL7)
                }
        ...
        Device (TPD8)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LEqual (GR13, One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y29._INT, VAL3)  // _INT: Interrupts
                    Store (0x1B, VAL3)
                    If (LEqual (S0ID, Zero))
                    {
                        CreateByteField (SBFI, 0x24, VAL4)
                ...
                If (LOr (LOr (LEqual (BID, 0x80), LEqual (BID, 0x82)), LEqual (BID, 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y29._INT, VAL7)  // _INT: Interrupts
                    Store (0x1A, VAL7)
                }
    ...
    Scope (_SB.PCI0.IGPU)
    {
        ...
        {
            If (LOr (LEqual (S0ID, One), LGreater (OSYS, 0x07DF)))
            {
                Return (Package (0x01)
                {
                    PEPD
    ...
    Scope (_SB.PCI0.SAT0)
    {
        Method (_DEP, 0, NotSerialized)  // _DEP: Dependencies
        {
            If (LAnd (LOr (LEqual (S0ID, One), LGreater (OSYS, 0x07DF)), LNotEqual (And (PEPC, 0x03), Zero)))
            {
                Return (Package (0x01)
                {
                    PEPD
    ...
    Scope (_SB)
    {
        Device (PEPD)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (LEqual (PCHS, 0x02))
                {
                    If (LOr (LGreater (OSYS, 0x07DF), LAnd (LGreaterEqual (OSYS, 0x07DC), LEqual (S0ID, One))))
                    {
                        Return (0x0F)
                    }
                }
