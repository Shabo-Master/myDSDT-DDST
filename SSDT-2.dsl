 ...
 *
 * Disassembly of SSDT-2.aml, Tue Oct  3 13:20:15 2017
 *
 ...
 */
DefinitionBlock ("", "SSDT", 2, "TrmRef", "PtidDevc", 0x00001000)
{
    /*
            ...
            Method (TSDD, 0, Serialized)
            {
                ...
                While (One)
                {
                                    ...
                                    }, MEQ, _T_0, MTR, Zero, Zero), Ones))
                    {
                        ...
                        {
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR1)), 0x0A), 0x0AAC), Index (TULT, 0x05))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR2)), 0x0A), 0x0AAC), Index (TULT, 0x06))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR3)), 0x0A), 0x0AAC), Index (TULT, 0x07))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR4)), 0x0A), 0x0AAC), Index (TULT, 0x08))
                            If (CondRefOf (\_SB.PCI0.LPCB.H_EC.TSR5))
                            {
                                Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR5)), 0x0A), 0x0AAC), Index (TULT, 0x09))
                            }

                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), 0x0A), 0x0AAC), Index (TULT, 0x0A))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7)), 0x0A), 0x0AAC), Index (TULT, 0x0B))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMAX)), 0x0A), 0x0AAC), Index (TULT, 0x0C))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)), 0x0A), 0x0AAC), Index (TULT, 0x0D))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)), 0x0A), 0x0AAC), Index (TULT, 0x0E))
                        }
                    ...
                    Else
                    {
                        ...
                        If (LEqual (\_SB.PCI0.LPCB.H_EC.ECAV, One))
                        {
                            ...
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR6)), 0x0A), 0x0AAC), Index (TMPV, 0x0A))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSR7)), 0x0A), 0x0AAC), Index (TMPV, 0x0B))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMAX)), 0x0A), 0x0AAC), Index (TMPV, 0x0C))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PPDT)), 0x0A), 0x0AAC), Index (TMPV, 0x0D))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)), 0x0A), 0x0AAC), Index (TMPV, 0x0E))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)), 0x0A), 0x0AAC), Index (TMPV, 0x0F))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD0)), 0x0A), 0x0AAC), Index (TMPV, 0x10))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD1)), 0x0A), 0x0AAC), Index (TMPV, 0x11))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD2)), 0x0A), 0x0AAC), Index (TMPV, 0x12))
                            Store (Add (Multiply (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.TSD3)), 0x0A), 0x0AAC), Index (TMPV, 0x13))
                        }
