 ...
 *
 * Disassembly of SSDT-9.aml, Tue Oct  3 13:20:15 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001982 (6530)
 *     Revision         0x01
 *     Checksum         0xA1
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.CLPG, MethodObj)    // 0 Arguments
    ...
    External (_SB_.PCI0.PEG0.LKSS, FieldUnitObj)
    ...
    {
        OperationRegion (GCRM, EmbeddedControl, Zero, 0x0100)
        Field (GCRM, ByteAcc, Lock, Preserve)
        {
            Offset (0x8E), 
                ,   5, 
            EC6I,   1, 
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        Method (GC6I, 0, Serialized)
        {
            ...
            While (LNotEqual (\_SB.PCI0.LPCB.EC.EC6R, One))
            {
                Sleep (One)
            }
            ...
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x26), Zero))
            {
                Sleep (One)
            }
        }
        ...
        {
            If (LEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x26), One))
            {
